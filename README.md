...
- Nếu máy ảo của mọi người chạy nhanh, có thể máy ảo sẽ tự độngđộng chuyển thẳng đến màn hình đăng nhập trước khi driver card âm thanh ảo (VB-AUDIO Cable) và driver màn hình ảo khi Parsec được cài đặt, đừng quá lo. Driver này sẽ sớm được cài đặt trên máy ảo.  
