...
* Tải file ISO Windows 10 mới nhất chính chủ của Microsoft [tại đây](https://www.microsoft.com/en-gb/software-download/windows10ISO) / Windows 11 ISO [tại đây](https://www.microsoft.com/en-us/software-download/windows11) - Mình khuyên mọi người đừng sử dụng Media Creation Tool, nếu không có link tải ISO trực tiếp (static) nào có sẵn, hãy làm theo [hướng dẫn này.](https://www.nextofwindows.com/downloading-windows-10-iso-images-using-rufus)
